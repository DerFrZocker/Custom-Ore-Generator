...
public class CustomOreBlockPopulator_v1_8_R3 extends BlockPopulator implements WorldHandler, Listener {

    @NotNull
    private final Supplier<CustomOreGeneratorService> serviceSupplier;

    public CustomOreBlockPopulator_v1_8_R3(@NotNull final JavaPlugin javaPlugin, @NotNull Supplier<CustomOreGeneratorService> serviceSupplier) {
