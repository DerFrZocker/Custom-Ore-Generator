...
public class ChunkOverrider extends ChunkGenerator {
    ...
    public ChunkOverrider(@NotNull final org.bukkit.World world, @NotNull final Supplier<CustomOreGeneratorService> serviceSupplier, @NotNull final ChunkGenerator parent, @NotNull WorldHandler_v1_16_R1 worldHandler) {
        super(null, null);
    ...
    public void storeStructures(GeneratorAccess generatoraccess, StructureManager structuremanager, IChunkAccess ichunkaccess) {
        parent.storeStructures(generatoraccess, structuremanager, ichunkaccess);
    }
    ...
    public void createStructures(StructureManager structuremanager, IChunkAccess ichunkaccess, DefinedStructureManager definedstructuremanager, long i) {
        parent.createStructures(structuremanager, ichunkaccess, definedstructuremanager, i);
    }
    ...
    private Set<Biome> getBiomes(final RegionLimitedWorldAccess access) {
        ...
        for (int x2 = x; x2 < x + 16; x2++)
            for (int z2 = z; z2 < z + 16; z2++) {
                ...
                try {
                    set.add(org.bukkit.Registry.BIOME.get(CraftNamespacedKey.fromMinecraft(IRegistry.BIOME.getKey(base))));
    ...
    private void generate(final OreConfig oreConfig, final RegionLimitedWorldAccess access, final Biome biome, final CustomOreGeneratorService service) {
        ...
        final BiomeBase biomeBase = IRegistry.BIOME.get(CraftNamespacedKey.toMinecraft(biome.getKey()));
