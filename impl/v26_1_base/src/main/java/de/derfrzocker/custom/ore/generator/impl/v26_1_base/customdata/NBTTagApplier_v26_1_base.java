...
public class NBTTagApplier_v26_1_base implements AbstractNBTTagCustomData.NBTTagApplier {

    @NotNull
    private final CustomData customData;

    public NBTTagApplier_v26_1_base(@NotNull final CustomData data) {
    ...
    public boolean hasCustomData(@NotNull final BlockState blockState) {
        final BlockEntity tileEntity = ((CraftWorld) blockState.getWorld())
                .getHandle()
                .getBlockEntity(new BlockPos(blockState.getX(), blockState.getY(), blockState.getZ()));
        ...
        return tileEntity
                       .saveWithoutMetadata(((CraftWorld) blockState.getWorld()).getHandle().registryAccess())
                       .size() != 0;
    }
