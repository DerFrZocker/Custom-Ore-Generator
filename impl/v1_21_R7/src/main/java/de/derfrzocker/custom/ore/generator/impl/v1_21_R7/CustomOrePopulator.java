...
public class CustomOrePopulator extends BlockPopulator {
    ...
    @NotNull
    private final WorldHandler_v1_21_R7 worldHandler;

    public CustomOrePopulator(@NotNull final org.bukkit.World world, @NotNull final Supplier<CustomOreGeneratorService> serviceSupplier, @NotNull WorldHandler_v1_21_R7 worldHandler) {
