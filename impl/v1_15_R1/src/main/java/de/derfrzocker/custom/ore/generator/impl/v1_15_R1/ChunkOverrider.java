...
public class ChunkOverrider<C extends GeneratorSettingsDefault> extends ChunkGenerator<C> {
    ...
    public ChunkOverrider(@NotNull final Supplier<CustomOreGeneratorService> serviceSupplier, @NotNull final ChunkGenerator<C> parent, @NotNull WorldHandler_v1_15_R1 worldHandler) {
